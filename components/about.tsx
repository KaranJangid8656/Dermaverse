    ...
    >
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md mb-8">
          ...
          <p>
            Our technology is continuously learning and improving, trained on diverse skin types, tones, and conditions
            to ensure accurate and inclusive analysis for all users.
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            ...
            <div>
              ...
              <p className="text-sm">
                Our AI examines your skin for various conditions, concerns, and characteristics.
              </p>
            </div>
